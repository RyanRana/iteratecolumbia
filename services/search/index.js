/**
 * Search API for TRACE (product catalog).
 * Serves GET /api/search?q=... using repo data/tech_products.json.
 * Run from repo root: node services/search/index.js
 */
const http = require('http');
const fs = require('fs');
const path = require('path');

const PORT = Number(process.env.SEARCH_PORT) || 3000;
